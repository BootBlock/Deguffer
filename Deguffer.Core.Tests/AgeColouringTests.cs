...
public class AgeColouringTests
{
    ...
    public void LabelsContrastWithTheColourTheirShapeWasPainted()
    {
        ...
        var surface = ExploreSurface.Create(
            tree, tree.RootNode, ExploreView.Icicle, Width, Height, scale: 1, ExploreColouring.Age, Now, ExploreSpacing.Comfortable, volumeFreeBytes: 0);
    ...
    public void AShapeStandingInForTheTooSmallIsPaintedOutsideBothSchemes(ExploreColouring colouring)
    {
        ...
        var surface = ExploreSurface.Create(
            tree, tree.RootNode, ExploreView.Treemap, Small, Small, scale: 1, colouring, Now, ExploreSpacing.Comfortable, volumeFreeBytes: 0);
    ...
    {
        var surface = ExploreSurface.Create(
            tree, tree.RootNode, ExploreView.Icicle, Width, Height, scale: 1, colouring, Now, ExploreSpacing.Comfortable, volumeFreeBytes: 0);
