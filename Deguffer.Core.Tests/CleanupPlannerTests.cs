    ...
    public void TheDefaultSetIsTheVerifiedSourcesAndEveryTierAboveOneIsNamed()
    {
        ...
        Assert.Equal(
            [
                ...
                "conda", "maven", "vcpkg", "steam-library-artwork", "steam-shader-cache", "emulator-shader-cache", "retroarch-downloads", "unreal-ddc", "affinity-model-cache", "capture-one-cache", "davinci-resolve-render-cache", "after-effects-disk-cache", "adobe-media-cache", "platformio", "playwright", "lmstudio-runtimes",
