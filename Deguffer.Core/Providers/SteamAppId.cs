...
///
/// <para><b>One test, because §5.2 hangs on it wherever Steam files things by game.</b>
/// <c>steamapps\shadercache</c> is one such container and <c>appcache\librarycache</c> is another. A
/// child that passes is a folder Steam made for one game; a child that fails is something nobody
/// established, and is Tier 4. Two copies of the rule would be two places for it to loosen.</para>
///
