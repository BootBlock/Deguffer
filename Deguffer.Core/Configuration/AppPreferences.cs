...
/// guard on recently changed files, and one holding only items on the keep list, all measure zero
/// and are not clear at all — each says so in its own words, and none of them is hidden by this.
///
