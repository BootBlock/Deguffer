...
public sealed class CleanupPlanner
{
    ...
    /// and the per-volume Recycle Bins — which the audit did not cover, and which were investigated
    /// on their own terms before being added. Their reasoning and their rejected alternatives are in
