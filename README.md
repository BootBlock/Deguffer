...
> **Status:** Version 0.70.0. Seventy-two sources across the tiers, a file-table-backed Explore view
...
Seventy-two providers, each holding its own knowledge of one location. A provider reports "not
