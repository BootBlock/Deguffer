...
> **Status:** Version 0.70.0. Sixty sources across the tiers, a file-table-backed Explore view
...
Sixty providers, each holding its own knowledge of one location. A provider reports "not
