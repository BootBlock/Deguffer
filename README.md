...
> **Status:** Version 0.70.0. Seventy-three sources across the tiers, a file-table-backed Explore view
...
Seventy-three providers, each holding its own knowledge of one location. A provider reports "not
